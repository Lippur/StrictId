...
/// or <c>uuid</c> (PostgreSQL). No string conversion, no prefix in the database. This
/// makes <see cref="Guid{T}"/> a true drop-in replacement for <see cref="Guid"/>
/// properties in existing EF Core models.
/// </summary>
